...
train_params = {
    ...
    'callbacks' : {
        'SaveModelCallback':{
            ...
            'fname':'unet++_4_right_fc_yaogan_best_model',
        }
    }
}
...
if __name__ == '__main__':
    ...
    fnames = get_image_files(path/'or_images')
    def label_func(x): return path/'or_labels'/f'{x.stem}.png'
    ...
    shutil.copy(path/'models'/'stage-0_unet++_4_right_fc_yaogan_best_model.pth', model_parh/'stage-0_unet++_4_right_fc_yaogan_best_model.pth')
